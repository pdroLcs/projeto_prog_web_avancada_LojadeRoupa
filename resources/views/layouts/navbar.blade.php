  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav me-auto">
        ...
        <x-nav-button-link href="{{ url('/clientes') }}" class="admin-link d-none" :active="Request()->routeIs('clientes.*')">Clientes</x-nav-button-link>
        <x-nav-button-link href="{{ url('/categorias') }}" class="admin-link d-none" :active="Request()->routeIs('categorias.*')">Categorias</x-nav-button-link>
      </ul>
    </div>
